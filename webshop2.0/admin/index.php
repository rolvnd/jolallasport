...
<title>Admin - Termékek mejelenítése</title>
</head>
<body>
                ...
                while($row = mysqli_fetch_array($result)){
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td> <img src="<?php echo $row["kep"]; ?>" alt="" style="width:45px; height:30px;"> </td>
                            <td><?php echo $row["nev"];  ?></td>
                            <td><?php  echo number_format($row["ar"], 0, ".", ".") ?> Ft</td>
                            <td><?php  echo $row["cikkszam"]; ?></td>
                            <td><?php  echo $row["keszlet"]; ?></td>
                            <td>
                                <a href="admin_modosit.php?id=<?php echo $row["id"]; ?>">
                                    <i class="fas fa-pen"></i>
                                </a>
                                <a href="admin_torol.php?id=<?php echo $row["id"]; ?>">
